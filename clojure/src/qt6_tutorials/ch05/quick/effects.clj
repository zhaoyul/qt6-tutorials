;; PySide6 Quick Visual Effects 示例 (Clojure + libpython-clj)

(ns qt6_tutorials.ch05.quick.effects)
...
(defn -main
  [& args]
  (println "=== PySide6 Quick Visual Effects 示例 (Clojure) ===")
