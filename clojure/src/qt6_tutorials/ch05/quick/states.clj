;; PySide6 Quick States & Transitions 示例 (Clojure + libpython-clj)

(ns qt6_tutorials.ch05.quick.states)
...
(defn -main
  [& args]
  (println "=== PySide6 Quick States & Transitions 示例 (Clojure) ===")
